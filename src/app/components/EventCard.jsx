...
export default function EventCard({ event }) {
  ...
  return (
    <div className="bg-neutral-900 rounded-lg shadow-md p-3 hover:bg-neutral-800 transition-colors border-solid max-w-xs min-h-[140px] flex flex-col justify-between">
      <div>
        ...
        <p className="text-blue-400 text-sm font-bold mt-0.5">Hosted by {event.host}</p>
      </div>
      <button
